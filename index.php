                ...
                <div class="container-fluid">
                    <div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-12">
                                <input type="password" name="senha" id="senha" value="<?= $senha ?>" class="form-control" placeholder="insira sua senha aqui" required><br>
                            ...
                            <div class="col-12">
                                <a href="cadastrar.php" class="cadastro">cadastre-se na rede moranguinho</a>
                            </div>
                        </div>
                    </div>
                </div>
